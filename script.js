customElements.define(
  ...
  class extends HTMLElement {
    constructor() {
      ...
      .like_btn {color: white; background-color: blue}
      .delete_btn {background-color: red}
      </style>
     
      <p></p>
      <br>
      <button id="submitBtn">Комментарий</button>
    ...
    setupListeners(comment) {
      comment.querySelector(".like_btn").addEventListener("click", () => {
      ...
      comment.querySelector(".delete_btn").addEventListener("click", () => {
        comment.remove();
      });
    }
  }
